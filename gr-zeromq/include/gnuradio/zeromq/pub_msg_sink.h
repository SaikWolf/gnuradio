...
public:
     ...
     * \param pkt_filter  A heading for subscribers to filter incoming messages with
     *
     */
    static sptr make(char* address, int timeout = 100, int linger = 0, bool bind = true, std::string pkt_filter = "");
